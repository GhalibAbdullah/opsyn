...
export const MainPage: React.FC<MainPageProps> = ({ onLogin, onSignUp }) => {
  ...
  const detailedFeatures = [
    {
      ...
      description: 'Create workflows using natural language. Just describe what you want, and our AI builds it for you.',
      badge: 'Popular'
    },
    {
      icon: Workflow,
      title: 'Visual Workflow Designer',
      description: 'Drag and drop interface for building complex automation workflows with ease.',
      badge: 'New'
    },
    {
      icon: Users,
    ...
    },
    {
      ...
      description: 'Track workflow performance, identify bottlenecks, and optimize your automations.',
      badge: null
    },
    {
      icon: Zap,
      title: 'Real-time Execution',
      description: 'Workflows run instantly with sub-second response times and 99.9% uptime.',
      badge: null
    }
  ];
  ...
  return (
    <div className="min-h-screen relative overflow-hidden" style={{ backgroundColor: '#0E0E10' }}>
      ...
      <div className="absolute inset-0" style={{ background: 'linear-gradient(165deg, #070500 0%, #05060A 25%, #050A15 45%, #1B0E1E 70%, #1d0210 100%)' }}></div>
      ...
      <nav className="relative z-20 w-full px-6 lg:px-8 py-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            />
            <span className="text-2xl font-bold" style={{ color: '#EAEAEA' }}>OPSYN</span>
          </div>

          {/* Navigation Links & Buttons */}
          <div className="hidden lg:flex items-center space-x-8">
            <a href="#features" className="font-medium transition-colors duration-200" style={{ color: '#A1A1A5' }} onMouseEnter={(e) => e.target.style.color = '#EAEAEA'} onMouseLeave={(e) => e.target.style.color = '#A1A1A5'}>
              Features
            </a>
            <a href="#integrations" className="font-medium transition-colors duration-200" style={{ color: '#A1A1A5' }} onMouseEnter={(e) => e.target.style.color = '#EAEAEA'} onMouseLeave={(e) => e.target.style.color = '#A1A1A5'}>
              Integrations
            </a>
            <a href="#docs" className="font-medium transition-colors duration-200" style={{ color: '#A1A1A5' }} onMouseEnter={(e) => e.target.style.color = '#EAEAEA'} onMouseLeave={(e) => e.target.style.color = '#A1A1A5'}>
              Docs
            </a>
            <a href="#community" className="font-medium transition-colors duration-200" style={{ color: '#A1A1A5' }} onMouseEnter={(e) => e.target.style.color = '#EAEAEA'} onMouseLeave={(e) => e.target.style.color = '#A1A1A5'}>
              Community
            </a>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <div className="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium backdrop-blur-sm" style={{ backgroundColor: 'rgba(161, 161, 165, 0.6)', color: '#EAEAEA' }}>
                <Heart className="w-4 h-4 mr-2" style={{ color: '#9B4A4A' }} />
                Free forever for everyone
              </div>
              
              <h1 className="text-5xl lg:text-7xl font-bold leading-tight tracking-tight" style={{ color: '#EAEAEA' }}>
                Welcome to
                <span className="block mt-2" style={{ color: '#9B4A4A' }}>OPSYN</span>
              </h1>
              
              <p className="text-xl lg:text-2xl leading-relaxed max-w-xl" style={{ color: '#A1A1A5' }}>
                Collaborative workflow automation, powered by AI &mdash; <span className="font-semibold" style={{ color: '#9B4A4A' }}>free for everyone</span>.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Button
                ...
                style={{ backgroundColor: '#1D0210' }}
                onMouseEnter={(e) => e.target.style.backgroundColor = '#160008'}
                onMouseLeave={(e) => e.target.style.backgroundColor = '#1D0210'}
              >
          ...
          {/* Right Column - Stunning Workflow Mockup */}
          <div className="relative lg:pl-8">
            {/* Background Glow Effects */}
            <div className="absolute inset-0 rounded-3xl blur-3xl transform rotate-3 scale-110" style={{ background: 'radial-gradient(circle, rgba(147, 51, 234, 0.2) 0%, rgba(147, 51, 234, 0.3) 50%, rgba(147, 51, 234, 0.2) 100%)' }}></div>
            
            <Card className="relative backdrop-blur-sm border shadow-2xl rounded-2xl overflow-hidden transform rotate-1 hover:rotate-0 transition-transform duration-500" style={{ backgroundColor: '#141419', borderColor: 'rgba(161, 161, 165, 0.4)' }}>
              <CardContent className="p-8">
                <div className="space-y-6">
                  {/* Workflow Header */}
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="text-xl font-bold" style={{ color: '#EAEAEA' }}>E-commerce Automation</h3>
                      <p className="text-sm mt-1" style={{ color: '#6D6D70' }}>Customer journey workflow</p>
                    </div>
                    <div className="flex items-center space-x-3">
                      <div className="flex items-center space-x-2">
                        <div className="w-3 h-3 rounded-full animate-pulse" style={{ backgroundColor: '#4ADE80' }}></div>
                        <span className="text-sm font-medium" style={{ color: '#A1A1A5' }}>Live</span>
                      </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="relative">
                      <div className="flex items-center space-x-4 p-4 rounded-xl text-white shadow-lg" style={{ background: 'linear-gradient(to right, #9B4A4A, rgba(155, 74, 74, 0.9))' }}>
                      ...
                      {/* Connection Line */}
                      <div className="absolute left-1/2 -bottom-2 w-0.5 h-4 transform -translate-x-0.5" style={{ backgroundColor: 'rgba(155, 74, 74, 0.3)' }}></div>
                    </div>

                    {/* Action Node 1 */}
                    <div className="relative">
                      <div className="flex items-center space-x-4 p-4 rounded-xl border shadow-md" style={{ backgroundColor: 'rgba(161, 161, 165, 0.1)', borderColor: 'rgba(155, 74, 74, 0.2)' }}>
                        <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ backgroundColor: 'rgba(155, 74, 74, 0.1)' }}>
                          <Database className="w-6 h-6" style={{ color: '#9B4A4A' }} />
                        </div>
                        <div className="flex-1">
                          <div className="font-semibold" style={{ color: '#EAEAEA' }}>Update Customer Record</div>
                          <div className="text-sm" style={{ color: '#6D6D70' }}>Add order details to CRM</div>
                        </div>
                        <div className="flex items-center space-x-2">
                          <CheckCircle className="w-4 h-4" style={{ color: '#4ADE80' }} />
                          <span className="text-xs font-medium" style={{ color: '#4ADE80' }}>Success</span>
                        </div>
                      </div>
                      {/* Connection Line */}
                      <div className="absolute left-1/2 -bottom-2 w-0.5 h-4 transform -translate-x-0.5" style={{ backgroundColor: 'rgba(155, 74, 74, 0.3)' }}></div>
                    ...
                    {/* Conditional Node */}
                    <div className="relative">
                      <div className="flex items-center space-x-4 p-4 rounded-xl border shadow-md" style={{ background: 'linear-gradient(to right, rgba(109, 109, 112, 0.1), rgba(161, 161, 165, 0.1))', borderColor: 'rgba(155, 74, 74, 0.3)' }}>
                        <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ backgroundColor: 'rgba(155, 74, 74, 0.15)' }}>
                          <GitBranch className="w-6 h-6" style={{ color: '#9B4A4A' }} />
                        </div>
                        <div className="flex-1">
                          <div className="font-semibold" style={{ color: '#EAEAEA' }}>Order Value Check</div>
                          <div className="text-sm" style={{ color: '#6D6D70' }}>If order &gt; $100</div>
                        </div>
                        <div className="px-3 py-1 rounded-full text-xs font-medium" style={{ backgroundColor: 'rgba(155, 74, 74, 0.1)', color: '#9B4A4A' }}>
                          Condition
                        </div>
                      </div>
                      {/* Connection Line */}
                    ...
                    <div className="flex items-center space-x-4 p-4 rounded-xl border shadow-md" style={{ backgroundColor: 'rgba(161, 161, 165, 0.1)', borderColor: 'rgba(155, 74, 74, 0.2)' }}>
                      ...
                      <div className="flex-1">
                        <div className="font-semibold" style={{ color: '#EAEAEA' }}>Send Thank You Email</div>
                        <div className="text-sm" style={{ color: '#6D6D70' }}>Personalized email with discount</div>
                      </div>
                      <div className="w-4 h-4 border-2 rounded-full animate-spin" style={{ borderColor: 'rgba(155, 74, 74, 0.3)', borderTopColor: '#9B4A4A' }}></div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-4 pt-6 border-t" style={{ borderColor: 'rgba(161, 161, 165, 0.2)' }}>
                    <div className="text-center">
                      <div className="text-2xl font-bold" style={{ color: '#9B4A4A' }}>1,247</div>
                      <div className="text-xs font-medium" style={{ color: '#6D6D70' }}>Executions</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold" style={{ color: '#4ADE80' }}>99.8%</div>
                      <div className="text-xs font-medium" style={{ color: '#6D6D70' }}>Success Rate</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold" style={{ color: '#A1A1A5' }}>2.3s</div>
                      <div className="text-xs font-medium" style={{ color: '#6D6D70' }}>Avg. Runtime</div>
                    </div>
                  </div>
                </div>
              </CardContent>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            {integrations.map((integration, index) => (
              <Card 
                ...
                style={{ 
                  ...
                  borderColor: 'rgba(161, 161, 165, 0.4)' 
                }}
                onMouseEnter={(e) => e.currentTarget.style.borderColor = 'rgba(155, 74, 74, 0.6)'}
                onMouseLeave={(e) => e.currentTarget.style.borderColor = 'rgba(161, 161, 165, 0.4)'}
              >
                <CardContent className="p-6 text-center">
                  <div className="flex flex-col items-center space-y-4">
                    ...
                    <div className="space-y-2">
                      <h3 className="font-semibold text-lg group-hover:transition-colors" style={{ color: '#EAEAEA' }}>
                        {integration.name}
                      </h3>
                      <Badge 
                        variant="outline" 
          ...
          <div className="text-center mt-12">
            ...
            <Button
              ...
              onMouseEnter={(e) => {
                e.target.style.backgroundColor = 'rgba(161, 161, 165, 0.2)';
                e.target.style.borderColor = '#9B4A4A';
              }}
              onMouseLeave={(e) => {
                e.target.style.backgroundColor = 'transparent';
                e.target.style.borderColor = 'rgba(155, 74, 74, 0.3)';
              }}
            >
              Request Integration
            </Button>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                <CardContent className="p-6 text-center">
                  <div className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:transition-all duration-300" style={{ background: 'linear-gradient(135deg, rgba(155, 74, 74, 0.1) 0%, rgba(161, 161, 165, 0.2) 100%)' }}>
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                ...
                onMouseEnter={(e) => {
                  e.target.style.backgroundColor = 'rgba(161, 161, 165, 0.1)';
                  e.target.style.borderColor = '#9B4A4A';
                }}
                onMouseLeave={(e) => {
                  e.target.style.backgroundColor = 'transparent';
