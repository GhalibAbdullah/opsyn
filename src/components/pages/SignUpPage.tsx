                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        onFocus={(e) => e.target.style.borderColor = '#1D0210'}
                        onBlur={(e) => e.target.style.borderColor = 'rgba(29, 2, 16, 0.3)'}
                        required
                      />
                    </div>
                  </div>
              ...
              <div className="text-center pt-4">
                <p className="text-sm" style={{ color: '#A1A1A5' }}>
                  ...
                  <Button
                    ...
                    style={{ color: '#1D0210' }}
                    onMouseEnter={(e) => e.target.style.color = 'rgba(29, 2, 16, 0.8)'}
                    onMouseLeave={(e) => e.target.style.color = '#1D0210'}
                  >
                    Login here
                  </Button>
                </p>
