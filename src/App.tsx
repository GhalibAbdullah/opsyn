...
export default function App() {
  ...
  const smartAnimateTransitions: Record<
    string,
  ...
  // When user clicks "Login" from anywhere, remember where they came from
  const handleLogin = () => {
  ...
  // After successful sign up, redirect back or to dashboard
  const handleSignUpComplete = () => {
    navigateToPage(returnTo || "dashboard");
    setReturnTo(null);
  };
  ...
  const renderCurrentPage = () => {
    ...
    const getTransition = (page: string) => {
      if (page === "main" || page === "signup" || page === "login") {
    ...
    switch (currentPage) {
      ...
      case "login":
        return (
          ...
          >
            <LoginPage
              onBack={() => navigateToPage(returnTo || "main")}
              onLoginSuccess={() => {
                navigateToPage(returnTo || "dashboard");
                setReturnTo(null);
              }}
  ...
  // Full-screen layout for public pages
  if (currentPage === "main" || currentPage === "signup" || currentPage === "login") {
    return (
      ...
      >
        <div className="h-full flex flex-col m-0 p-0">
          ...
          <div
            ...
            style={{ margin: 0, padding: "1.5rem 1rem" }}
          >
              ...
              >
                ...
                <Input
                  ...
                  style={{
                    ...
                    color: "#EAEAEA",
                    // Note: placeholder styling should be done with Tailwind or CSS
                  }}
                  value={searchQuery}
